    ...
    <div class="auth-modal-card">
        ...
        <div id="loginView">
            ...
            <div class="social-login-group">
                <!-- 1. GOOGLE LOGIN -->
                <a href="{{ url('/auth/google') }}" class="btn-social-auth btn-google-auth" id="btnGoogleAuth">
            ...
            <div style="text-align: center; margin-top: -8px; margin-bottom: 12px;">
                <a href="javascript:void(0)" onclick="switchAuthTab('googleChooser')" style="font-size: 11.5px; color: var(--muted); text-decoration: underline;">
