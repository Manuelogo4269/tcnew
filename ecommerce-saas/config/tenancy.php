...
return [
    ...
    'bootstrappers' => [
        ...
        // Stancl\Tenancy\Bootstrappers\CacheTenancyBootstrapper::class, // Requires tag-compatible store like Redis
    ...
    'database' => [
         ...
         */
        'template_tenant_connection' => env('DATABASE_URL') ? 'pgsql' : 'sqlite',
         ...
         */
        'prefix' => 'tenant_',
        'suffix' => env('DATABASE_URL') ? '' : '.sqlite',
